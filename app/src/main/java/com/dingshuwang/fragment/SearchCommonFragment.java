...
public class SearchCommonFragment extends BaseFragment implements DataView {
    ...
    public static SearchCommonFragment newInstance(){
        SearchCommonFragment fragment = new SearchCommonFragment();
    ...
    public void onGetDataSuccess(String result, String requestTag) {
        if(result != null){
            if(SEARCH_KEY.equals(requestTag)){
                ...
                if(search!= null && search.result!=null && search.result.equals("true") && search.pros != null && search.pros.size() > 0){
