...
public class XListViewFooter extends LinearLayout {
	...
	public XListViewFooter(Context context, boolean loadMore) {
		super(context);
		initView(context, loadMore);
	}

	public XListViewFooter(Context context, AttributeSet attrs, boolean loadMore) {
		super(context, attrs);
		initView(context, loadMore);
	}
	...
	private void initView(Context context, boolean loadMore) {
		mContext = context;
